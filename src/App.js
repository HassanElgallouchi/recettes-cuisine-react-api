  ...
  return (
   ...
   <Router>
      ...
      <Switch> 
        ...
        <Route exact path='/Nom/:filterSearch/:select/:input' component={RecipeByName}/>
  
        <Route exact path='/Category/:filterSearch/:select/:input' component={RecipeByCategorie}/>
        <Route exact path='/Ingredient/:filterSearch/:select/:input' component={RecipeByCategorie}/>  
        <Route exact path='/Origine/:filterSearch/:select/:input' component={RecipeByCategorie}/>   
